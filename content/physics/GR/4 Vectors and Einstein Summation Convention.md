...
$$
If we write out the expression for $\Delta t'$, we have 
$$
\Delta x^{\overset{-}{0}} = \sum_{\beta =0}^{3} \Lambda^{\overset{-}{0}}_{\beta}\Delta x^{\beta}
$$
...
$$
or, over all possible coordinates, as 
$$
\Delta x^{\overset{-}{\alpha}} = \Lambda^{\overset{-}{\alpha}}_{\beta}\Delta x^{\beta}
$$
